...
const Quiz = () => {
  ...
  const calculateTotalScore = () => {
    ...
    if (calculatedScore >= 12 && calculatedScore <= 20) {
      ...
      history.push("/src/components/Trade/TradeLayout.jsx");
    } else if (calculatedScore >= 33 && calculatedScore <= 44) {
      history.push("/src/components/Trade/TradeLayout.jsx");
    } else if (calculatedScore >= 45 && calculatedScore <= 48) {
      history.push("/src/components/Trade/TradeLayout.jsx");
    }
  };
  ...
  return (
    <>
      <div className='bg-[#836FFF] min-h-screen flex items-center justify-center'>
        <div className="quiz-container Container flex-col mx-auto bg-white w-3/5 h-4/5 px-6 py-5 rounded-xl border-slate-900 border-2 overflow-hidden">
          ...
          {currentQuestion < questions.length - 1 ? (
            <button onClick={handleNext} className='relative inline-flex items-center justify-center p-0.5 mb-2 me-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg bg-green-400  hover:text-white border-2 border-slate-500 dark:text-white ml-96 mt-6 '>
            ...
            <button onClick={calculateTotalScore} className='relative inline-flex items-center justify-center p-0.5 mb-2 me-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg bg-green-400  hover:text-white border-2 border-slate-500 dark:text-white ml-96 mt-6'>
              <span className="relative px-5 py-2.5 transition-all ease-in duration-75 dark:bg-gray-900 rounded-md group-hover:bg-opacity-0">
                Submit
              </span>
            </button>
